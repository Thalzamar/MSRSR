...
mods.nuclearcraft.Registration.registerFissionHeater("copperwl","water",5,"low_pressure_steam",20,80,"one standard heater");
...
mods.nuclearcraft.Registration.registerFissionHeater("copperre","exhaust_steam",19,"low_pressure_steam",19,76,"one standard heater");
